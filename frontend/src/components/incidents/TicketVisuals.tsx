...
import { AlertCircle, CheckCircle2, CircleDot, Lock, XCircle } from 'lucide-react';
...
const statusConfig: Record<TicketStatus, { bg: string; icon: React.ReactNode }> = {
  OPEN: {
    ...
    icon: <CircleDot size={11} className="shrink-0" />,
  },
  IN_PROGRESS: {
  ...
  CLOSED: {
    bg: 'bg-slate-100 text-slate-700 border-slate-200/80 ring-1 ring-slate-200',
